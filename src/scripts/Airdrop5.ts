...
// Epoch = 2024-08-09 to 2024-09-06

// 7.5M tokens to lenders
// 1.0M tokens to borrowers
// 1.5M tokens to stakers

const TARGET_FILENAME = 'aidrop-data-5.json';
...
async function computeAirdropData() {
  ...
  const startDate = new Date(2024, 7, 9, 3, 55, 13);
  const endDate = new Date(2024, 8, 5, 11, 47, 55);
