...
// Epoch = 2024-07-11 to 2024-08-09
...
const TARGET_FILENAME = 'aidrop-data-4.json';
...
async function computeAirdropData() {
  ...
  const startDate = new Date(2024, 6, 11, 3, 55, 13);
  const endDate = new Date(2024, 7, 9, 3, 55, 13);
